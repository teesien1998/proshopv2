...
const OrderScreen = () => {
  ...
  useEffect(() => {
    if (!errorPaypalId && !loadingPaypalId && paypalId.clientId) {
      ...
      if (order && !order.isPaid) {
        if (!window.paypal) {
          loadingPayPalScript(); // Call the loadingPayPalScript()
        }
      }
    }
  }, [loadingPaypalId, errorPaypalId, order, paypalId, paypalDispatch]);
